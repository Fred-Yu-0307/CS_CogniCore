                    ...
                    <div class="row py-4">
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card2">
                                ...
                                <div class="card__title">Alexandra Alejo</div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-8">
                            <h2 class="pt-5">Dashboard</h2>
                            <div class="row flex-col align-items-center justify-content-center pt-5">
                                <div class="col-sm-12 col-lg-6">
                                    <div class="card3">
                                        <div class="image"><p>CC103</p></div>
                                         <div class="content">
                                           <a href="#">
                                             <span class="title">
